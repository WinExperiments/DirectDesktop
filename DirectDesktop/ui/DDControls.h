...
namespace DirectDesktop
{
    ...
    public:
        ...
        static void UpdateTEPreview(Element* elem, const PropertyInfo* pProp, int type, Value* pV1, Value* pV2);
    ...
    public:
        ...
        BYTE GetSmallPos();
        BYTE GetMasterSmallPos();
        void SetSmallPos(BYTE smPos);
        void SetMasterSmallPos(BYTE smPos);
