...
namespace DDUI
{
    ...
    COLORREF GetDominantColorFromIcon(HBITMAP hbm, int iconsize, int nonGreyishThreshold, DWORD dwBits)
    {
        COLORREF outDominantColor = (dwBits & 0x1000000) ? (0xFF000000 | (dwBits & 0x00FFFFFF)) :
            (dwBits & 0x2000000) ? RGB(80, 84, 88) : RGB(128, 136, 144);
